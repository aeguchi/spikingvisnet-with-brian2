...
ksize = 31  # 31 the size of the Gabor kernel. If ksize = (a, b), we then have a Gabor kernel of size a x b pixels. As with many other convolution kernels, ksize is preferably odd and the kernel is a square (just for the sake of uniformity).
...
lamdaList = [2.0, 16.0]; #wavelength: the wavelength of the sinusoidal factor in the above equation.
