...
if not os.path.exists(glob.iglob(os.path.split(os.path.realpath(__file__))[0] + "/randomised/")): 
    os.makedirs(glob.iglob(os.path.split(os.path.realpath(__file__))[0] + "/randomised/"))
if not os.path.exists(glob.iglob(os.path.split(os.path.realpath(__file__))[0] + "/trained/")):
    os.makedirs(glob.iglob(os.path.split(os.path.realpath(__file__))[0] + "/trained/"))
