...
FR=pickle.load(open(os.path.split(os.path.realpath(__file__))[0] +"/Results/"+ExperimentName+"/FR_0_blank.pkl", "rb"));
#FR=pickle.load(open(os.path.split(os.path.realpath(__file__))[0] +"/Results/"+ExperimentName+"/FR_1_trained.pkl", "rb"));
numObj = FR.shape[0];
numTrans = FR.shape[1];
...
#print np.around(FR[:,:,layer,:,:]*(numBins-1))
